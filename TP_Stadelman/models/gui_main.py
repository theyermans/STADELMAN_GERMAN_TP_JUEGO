...
flags = DOUBLEBUF 
screen = pygame.display.set_mode((screen_w,screen_h), flags, 16)
pygame.init()
...
form_menu_C = FormMenuC(name="form_menu_C",master_surface = screen,x=0,y=0,w=screen_w,h=screen_h,color_background=(0,255,255),color_border=(255,0,255),active=False)

form_game_L1 = FormGameLevel1(name="form_game_L1",master_surface = screen,x=0,y=0,w=screen_w,h=screen_h,color_background=(0,255,255),color_border=(255,0,255),active=False)
